<div class="container-fluid footer-bg text-secondary mt-5 pt-5">
        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                <div class="col-md-4 mb-5">
                    <h5 class="font-weight-bold text-secondary mb-4">Quick Links</h5>
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-secondary mb-2" href="detail.html"><i class="fa fa-angle-right mr-2"></i>Shop
                            Detail</a>
                        <a class="text-secondary mb-2" href="cart.html"><i class="fa fa-angle-right mr-2"></i>Shopping
                            Cart</a>
                ...
                <div class="col-md-4 mb-5">
                    <h5 class="font-weight-bold text-secondary mb-4">Newsletter</h5>
                    <form action="">
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-secondary">
                &copy; <a class="text-secondary font-weight-semi-bold" href="#">Your Site Name</a>
            </p>
        </div>
        <div class="col-md-6 px-xl-0 text-center text-md-right">
            <img class="img-fluid" src="{{ asset('asset/frontend/img/payments.png') }}" alt="">
        </div>
    </div>
</div>
