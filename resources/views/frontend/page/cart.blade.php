                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="product-price col-lg-3 col-md-4">
                                        <div class="d-flex">
                                            ...
                                            <del class="text-muted px-2">${{ number_format($product['unit_price']) }}</del>
                                        </div>
                                    ...
                                    <div class="product-qunatiy col-lg-3 col-md-4">
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                            ...
                                            <input min="1" type="text" value="{{ $product['qty'] }}"
                                                name="qty" class="form-control form-control-sm text-center qty">
                                            <div class="input-group-btn">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <a href="{{ route('product.checkout') }}"
                            class="btn btn-block btn-warning font-weight-semi-bold text-white"
                            style="text-transform: uppercase">Proceed To Checkout</a>
                    </div>
                </div>
            </div>
        </div>
