<div class="container-fluid  mb-5" style="height: 400px; overflow: hidden;">
    <div class="row">
        <div class="col-lg-4 px-5">
            <nav class="navbar navbar-vertical navbar-light align-items-start bg-light sidebar">
                <ul class="navbar-nav w-100">
                    @foreach ($categories as $category)
                        <li class="category-menu nav-item">
                            <a href="javascript:void(0)" class="nav-link px-2">
                                <img src="{{ asset($category->icon)}}" alt="" style="width: 25px" class="mr-2">{{ $category->name }}
